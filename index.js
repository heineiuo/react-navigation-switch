...
const getDefaultHeaderHeight = (layout, statusBarHeight) => {
  ...
  if (reactNative.Platform.OS === "ios") {
    if (isLandscape && !reactNative.Platform.isPad) {
      headerHeight = 32;
    } else {
      headerHeight = 44;
    }
...
function Header(props) {
  ...
  const {
    title,
    headerTitle,
    headerTitleAlign = reactNative.Platform.select({
      ios: "center",
      default: "left"
    }),
    headerLeft,
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(reactNative.View, {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx(reactNative.View, {
      ...
      children: [leftButton ? /*#__PURE__*/jsxRuntime.jsx(reactNative.View, {
        pointerEvents: "box-none",
        style: [styles.left, {
          left: insets.left
        }],
        children: leftButton
      }) : null, /*#__PURE__*/jsxRuntime.jsx(reactNative.View, {
        pointerEvents: "box-none",
        ...
        children: typeof headerTitle === "function" ? headerTitle({
      ...
      }), rightButton ? /*#__PURE__*/jsxRuntime.jsx(reactNative.View, {
        pointerEvents: "box-none",
        style: [styles.right, {
          right: insets.right
        }],
...
function SwitchNavigator(props) {
  ...
  const {
    ...
    navigation,
    descriptors
  } = native.useNavigationBuilder(native.TabRouter, {
    children,
    screenOptions,
    initialRouteName
  });
  const dimensions = reactNative.useWindowDimensions();
  return /*#__PURE__*/jsxRuntime.jsx(native.NavigationHelpersContext.Provider, {
    value: navigation,
    children: /*#__PURE__*/jsxRuntime.jsx(reactNative.View, {
      style: [{
        flex: 1
      ...
      children: state.routes.map((route, i) => {
        ...
        const {
          header = props => /*#__PURE__*/jsxRuntime.jsx(Header, { ...props
          }),
          headerShown = false
        } = descriptor.options;
        return /*#__PURE__*/jsxRuntime.jsxs(reactNative.View, {
          ...
          children: [headerShown ? /*#__PURE__*/jsxRuntime.jsx(native.NavigationContext.Provider, {
            value: descriptor.navigation,
            children: /*#__PURE__*/jsxRuntime.jsx(native.NavigationRouteContext.Provider, {
              value: route,
              children: header({
                layout: dimensions,
                scene: {
...
const styles = reactNative.StyleSheet.create({
  container: { ...reactNative.Platform.select({
      android: {
        elevation: 4
      },
      ios: {
...
const createSwitchNavigator = native.createNavigatorFactory(SwitchNavigator);
